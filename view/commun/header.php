            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <?php if (!isset($_SESSION['user_id'])): ?>
                        ...
                        <li class="nav-item"><a class="nav-link text-dark" href="index.php?page=login" title="Connexion"><i class="fas fa-user-circle"></i>
                    <?php else: ?>
                        <!-- Si l'utilisateur est connecté, afficher les autres pages -->
                    <?php 
                            if (isset($_SESSION['user_id'])) {
                                echo "Bienvenu : " . $_SESSION['user_name'];
                            } else {
                                echo "Non connecté.";
                            }?>

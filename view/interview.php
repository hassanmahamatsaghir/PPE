...
<section class="container my-5">
    <h2 class="text-center text-primary fw-bold mb-4">Metiers</h2>
    <div class="row">
        <!-- Interview 1: Architecte -->
        ...
        <!-- Interview 2: Développeur Informatique -->
        <div class="col-md-6 mb-4">
            <div class="card shadow-sm border-0">
                <div class="card-body">
